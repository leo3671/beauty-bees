      ...
      <section style={{ padding: '60px 20px' }}>
        <div className="container" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '30px' }}>
          <div style={{ padding: '30px', borderRadius: '16px', background: 'white', boxShadow: '0 10px 30px rgba(0,0,0,0.03)', textAlign: 'center' }}>
            <div style={{ width: '50px', height: '50px', background: '#fdf2f8', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyCenter: 'center', margin: '0 auto 20px', color: '#be185d' }}>
              <Mail size={24} />
            </div>
            <h3 style={{ marginBottom: '10px' }}>Email Us</h3>
            <p style={{ color: '#8a7b7e' }}>support@beautybees.com.np</p>
          </div>
          ...
          <div style={{ padding: '30px', borderRadius: '16px', background: 'white', boxShadow: '0 10px 30px rgba(0,0,0,0.03)', textAlign: 'center' }}>
            ...
            <p style={{ color: '#8a7b7e' }}>+977 980-0000000</p>
          </div>
          ...
          <div style={{ padding: '30px', borderRadius: '16px', background: 'white', boxShadow: '0 10px 30px rgba(0,0,0,0.03)', textAlign: 'center' }}>
            ...
            <p style={{ color: '#8a7b7e' }}>Message us for skin advice</p>
          </div>
