...
export async function sendOrderConfirmation(order) {
  ...
  const info = await t.sendMail({
    from: '"Beauty Bees" <orders@beautybees.com.np>',
    to: order.email,
...
export async function sendOrderDelivered(order) {
  ...
  await t.sendMail({
    from: '"Beauty Bees" <orders@beautybees.com.np>',
    to: order.email,
    subject: `Delivered: Your Beauty Bees Order ${order.id} 💖`,
    html: html,
  });
}
...
export async function sendOrderCancelled(order) {
  ...
  await t.sendMail({
    from: '"Beauty Bees" <security@beautybees.com.np>',
    to: order.email,
...
export async function sendPaymentVerificationEmail(order) {
  ...
  await t.sendMail({
    from: '"Beauty Bees" <billing@beautybees.com.np>',
    to: order.email,
